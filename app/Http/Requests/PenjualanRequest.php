...
class PenjualanRequest extends FormRequest
{
        ...
        if ($this->type == 'store-all') {
            $validate =
                [
                    ...
                    'detail.*.harga_satuan' => 'required|numeric|digits_between:0,20',
                    'detail.*.quantity' => 'required|numeric|between:0,99999999.99',
                    'detail.*.diskon' => 'required|numeric|between:0,99999999.99',
                    'detail.*.subtotal' => 'required|numeric|digits_between:0,20',
    ...
    public function messages()
    {
        return [
            ...
            'detail.*.harga_satuan.digits_between' => 'Harga satuan minimal 0 digit dan maksimal 20 digit',
