...
@section('content')
    ...
    <form name="form_detail" id="formDetail" method="POST" action="{{ route('pembelian.update.detail', $detailBeli->id) }}">
        ...
        <div class="mb-3">
            ...
            <input type="text" id="inputQuantity" class="form-control quantity" name="quantity"
        ...
        <div class="mb-3">
            ...
            <input type="text" id="inputDiskonPersen" class="form-control diskon-persen" name="diskon_persen"
        ...
        <div class="mb-3">
            ...
            <input type="text" id="inputDiskonRupiah" class="form-control diskon-rupiah mata-uang" name="diskon_rupiah"
