    ...
    <div class="card  mb-3">
                    ...
                    <form id="formTotal" action="{{ route('dashboard.total') }}" method="POST">
                        ...
                        <div class="d-flex align-items-center">
                            <input type="text" name="start_range" id="inputStartDateJumalahRange"
                                class="total-range form-control" aria-describedby="basic-addon1"
                                data-date-format="d-mm-yyyy" data-provide="datepicker" placeholder="All Time">
        ...
        <div class="card-body">
            <div class="row">
                ...
                <div class="col-xl-4 col-md-6">
                    <div class="card  text-white mb-4" style="background: violet">
                        <div class="card-header">
                            Sisa Pakan Dalam Tong
                        </div>
                        <div class="card-body">
                            <h2 class="fw-bold counter" id="totalPakanDalamTong">0</h2>
                        </div>

                    </div>
                </div>
                <div class="col-xl-4 col-md-6">
                    <div class="card text-white mb-4" style="background: chocolate">
                        <div class="card-header">
                            Total Ikan Sortir
                        </div>
                        <div class="card-body">
    ...
    <script>
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                let totalPakanDalamTong = response.total_pakan_dalam_tong
                if (response.total_pakan_dalam_tong % 1 === 0) {
                    totalPakanDalamTong = parseInt(response.total_pakan_dalam_tong);
                }


                $('#totalPakanDalamTong').html(totalPakanDalamTong)
                $(".counter").countUp({
                    'time': 500,
                    'delay': 10
                });
        ...
        $('#formTotal').on('submit', function(e) {
            e.preventDefault();
